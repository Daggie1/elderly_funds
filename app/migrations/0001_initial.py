# Generated by Django 2.2 on 2020-07-21 06:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.DocumentFile')),
                ('resolved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='resolver', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
            fields=[
                ('file_number', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('comment', models.TextField(blank=True, null=True)),
                ('name', models.CharField(max_length=80)),
                ('nationality', models.CharField(max_length=50)),
                ('cross_reference', models.CharField(max_length=60)),
                ('file_category', models.CharField(choices=[('TEMPORARY', 'Temporary'), ('PERMANENT', 'Permanent'), ('PARALLEL', 'Parallel')], max_length=60)),
                ('date_last_correspondence', models.DateTimeField(null=True)),
                ('date_first_correspondence', models.DateTimeField(null=True)),
                ('location_of_file', models.CharField(choices=[('REGISTRY', 'Registry'), ('CITIZENSHIP', 'Citizenship'), ('INVESTIGATION', 'Investigation'), ('VISA', 'Visa'), ('PERMITS', 'Permits'), ('PERMANENT_RESIDENCE', 'Permanent Residence'), ('INTERVIEW', 'Interview')], max_length=40)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
