# Generated by Django 2.2 on 2020-04-02 06:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Batch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejection_by_receiver_dec', models.TextField(null=True)),
                ('rejection_by_scanner_dec', models.TextField(null=True)),
                ('rejection_by_transcriber_dec', models.TextField(null=True)),
                ('rejection_by_aq_dec', models.TextField(null=True)),
                ('rejection_by_validation_dec', models.TextField(null=True)),
        ...
        migrations.AddField(
            model_name='documentfiledetail',
            name='state',
            field=models.ForeignKey(db_column='state_code', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.DocumentState'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='batch',
            name='receive_state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='received_state', to='app.DocumentState'),
        ),
        migrations.AddField(
            model_name='batch',
            name='received_by',
        ...
        migrations.AddField(
            model_name='batch',
            name='return_state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='return_state', to='app.DocumentState'),
        ),
    ]
